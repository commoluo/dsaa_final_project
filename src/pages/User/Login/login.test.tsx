...
describe('Login Page', () => {
  ...
  it('should show login form', async () => {
    ...
    await rootContainer.findAllByText('HKUST');
    ...
    expect(rootContainer.baseElement?.querySelector('.ant-pro-form-login-desc')?.textContent).toBe(
      'HKUST is the most influential web design specification in Xihu district',
    );
  ...
  it('should login success', async () => {
    ...
    await rootContainer.findAllByText('HKUST-GZ');
